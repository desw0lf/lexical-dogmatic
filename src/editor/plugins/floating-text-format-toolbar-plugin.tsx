...
type TextFormatFloatingToolbarProps = TextFormatFloatingToolbarBase & WithTranslation;

const TextFormatFloatingToolbar = withTranslation()(TextFormatFloatingToolbarWoT) as React.FC<TextFormatFloatingToolbarBase>;

function TextFormatFloatingToolbarWoT({
  editor,
  anchorElem,
  isLink,
  isBold,
